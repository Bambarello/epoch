...
primop_base_gas(?PRIM_CALL_MAP_EMPTY          ) -> 1000;
primop_base_gas(?PRIM_CALL_MAP_GET            ) -> 1000;
primop_base_gas(?PRIM_CALL_MAP_PUT            ) -> 1000;
primop_base_gas(?PRIM_CALL_MAP_DELETE         ) -> 1000;
primop_base_gas(?PRIM_CALL_MAP_SIZE           ) -> 1000;
primop_base_gas(?PRIM_CALL_MAP_TOLIST         ) -> 6000.
