...
identity_contract(Config) ->
    ...
    ensure_balance(CPub, 2000000),
    ensure_balance(DPub, 2000000),
...
simple_storage_contract(Config) ->
    ...
    _BBal0 = ensure_balance(BPub, 2000000),
    {ok,[_]} = aecore_suite_utils:mine_key_blocks(Node, 1),
...
environment_contract(Config) ->
    ...
    %% Make sure accounts have enough tokens.
    _ABal0 = ensure_balance(APub, 10000000),
    BBal0 = ensure_balance(BPub, 10000000),
...
spend_test_contract(Config) ->
    ...
    %% Make sure accounts have enough tokens.
    _ABal0 = ensure_balance(APub, 2000000),
    BBal0 = ensure_balance(BPub, 1000000),
